...
We have discovered there is some incability with the current `SW-Tutorial.zip` file that is included in the repository. So please download the most updated version from this link: [2026-sw-tutorial.zip](../tutorial-0-Introduction/01-installs/2026-sw-tutorial.zip)
...
5. You should be seeing this now:
   ![](<../images/ST-Updated Tutorial zip.png>)
